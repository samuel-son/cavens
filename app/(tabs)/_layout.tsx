...
type TabIconName = 'home' | 'shield-checkmark' | 'bag-handle' | 'trending-up' | 'flash';

const TAB_CONFIG: {
  name: string; title: string; icon: TabIconName; isPrimary?: boolean;
}[] = [
          ...
          return (
            ...
            >
              {config.isPrimary && isFocused ? (
                ...
                >
                  <Ionicons name={config.icon} size={22} color={Colors.textInverse} />
                </LinearGradient>
              ) : (
              ...
              <Text
                style={[
                  styles.tabLabel,
                  { color: isFocused ? (config.isPrimary ? Colors.gold : Colors.textPrimary) : Colors.tabBarInactive },
